    ...
    <div className={inter.className} style={{ 
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span className={playfair.className} style={{ fontWeight: 700, fontSize: 24, letterSpacing: '0.02em', color: '#fff' }}>Kylst</span>
          </div>
          
          <div style={{ display: 'none', md: 'flex', gap: 40, fontSize: 13, fontWeight: 500, color: '#a1a1aa', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
            <a href="#craft" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={e => e.target.style.color = '#fff'} onMouseOut={e => e.target.style.color = '#a1a1aa'}>The Craft</a>
            <a href="#performance" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={e => e.target.style.color = '#fff'} onMouseOut={e => e.target.style.color = '#a1a1aa'}>Performance</a>
            <a href="#membership" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={e => e.target.style.color = '#fff'} onMouseOut={e => e.target.style.color = '#a1a1aa'}>Membership</a>
          </div>
      ...
      <section style={{ position: 'relative', paddingTop: 180, paddingBottom: 100, minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }}
          ...
          ✦ Elite agencies scalable system
        </motion.div>
        ...
        <motion.h1 style={{ opacity, scale }} className={playfair.className}>
          <div style={{
            ...
            <span style={{ color: '#f97316', fontStyle: 'italic' }}>the Outreach.</span>
          </div>
        </motion.h1>
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.4 }}
          ...
          Kylst isn&apos;t just a tool; it&apos;s your competitive advantage. Elevate your cold
          email strategy with precision, elegance, and unmatchable deliverability.
        </motion.p>
          ...
          <div style={{
            ...
            <div style={{ padding: 40, display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 24, height: '100%' }}>
              ...
              <div style={{ background: 'rgba(0,0,0,0.4)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.03)', padding: 32, display: 'flex', flexDirection: 'column' }}>
                <div style={{ color: '#a1a1aa', fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 8 }}>Campaign Performance</div>
                <div style={{ fontSize: 48, fontWeight: 300, color: '#fff', marginBottom: 40 }}>42.6% <span style={{ fontSize: 16, color: '#f97316' }}>↗ +12% vs last week</span></div>
              ...
              <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: 24 }}>
                <div style={{ background: 'rgba(0,0,0,0.4)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.03)', padding: 32 }}>
                  <div style={{ color: '#a1a1aa', fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 8 }}>Open Rate</div>
                  <div style={{ fontSize: 36, fontWeight: 300, color: '#fff', marginBottom: 16 }}>68.2%</div>
                  <div style={{ height: 4, background: 'rgba(255,255,255,0.1)', borderRadius: 2 }}>
                    <div style={{ width: '68%', height: '100%', background: '#7c3aed', borderRadius: 2, boxShadow: '0 0 10px #7c3aed' }} />
                  </div>
                </div>
                <div style={{ background: 'rgba(0,0,0,0.4)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.03)', padding: 32 }}>
                   <div style={{ color: '#a1a1aa', fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 8 }}>Reply Rate</div>
                  <div style={{ fontSize: 36, fontWeight: 300, color: '#fff', marginBottom: 16 }}>14.5%</div>
                  <div style={{ height: 4, background: 'rgba(255,255,255,0.1)', borderRadius: 2 }}>
                    <div style={{ width: '14%', height: '100%', background: '#f97316', borderRadius: 2, boxShadow: '0 0 10px #f97316' }} />
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* ====== THE CRAFT (3D Cards) ====== */}
      <section id="craft" style={{ padding: '160px 32px', position: 'relative' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 100 }}>
            ...
            <p style={{ fontSize: 18, color: '#a1a1aa', maxWidth: 600, margin: '0 auto', fontWeight: 300, lineHeight: 1.6 }}>
              Our proprietary engine dissects data, synthesizes personalization, and ensures delivery to primary inboxes.
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
            {[
              { id: 'diamond', title: 'Analysis', desc: 'AI dissects prospect data to find unique angles, ensuring every outreach attempt feels hand-researched.' },
              { id: 'globe', title: 'Synthesis', desc: 'Hyper-personalization at scale using generative models that adapt tone and style to match the recipient.' },
              { id: 'pyramid', title: 'Delivery', desc: 'Proprietary warm-up networks ensure your message lands in primary inboxes, never spam folders.' }
            ].map((feature, i) => (
              <div key={i} style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'center' }}>
          ...
          <div>
            <h2 className={playfair.className} style={{ fontSize: 'clamp(40px, 5vw, 56px)', fontWeight: 500, color: '#fff', marginBottom: 24, lineHeight: 1.1 }}>
              Sophistication Meets <br/>
              <span style={{ color: '#7c3aed', fontStyle: 'italic' }}>Performance</span>
            </h2>
            <p style={{ fontSize: 18, color: '#a1a1aa', maxWidth: 500, fontWeight: 300, lineHeight: 1.6, marginBottom: 48 }}>
              Experience the future of cold outreach with tools designed for precision and scale.
            </p>

            <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
              {[
                { title: 'Unrivaled Precision', desc: 'Target exactly who you need with granular filters and AI validation.' },
                { title: 'Seamless Integration', desc: 'Connects effortlessly with your CRM, LinkedIn, and existing tech stack.' },
                { title: 'White-Glove Support', desc: '24/7 priority access to our team of email deliverability experts.' }
              ].map((item, i) => (
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '120px 32px', textAlign: 'center' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <h3 className={playfair.className} style={{ fontSize: 'clamp(28px, 4vw, 40px)', fontWeight: 500, color: '#fff', fontStyle: 'italic', lineHeight: 1.4, marginBottom: 40 }}>
            The interface feels like a private club. The results feel like magic. We closed 3 high-ticket deals in the first week.
          </h3>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: '#fff', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>Michael Ray</div>
            <div style={{ fontSize: 13, color: '#a1a1aa' }}>SVP of Sales, TechNova</div>
          </div>
        </div>
      </section>
      ...
      <section id="membership" style={{ position: 'relative', zIndex: 1, padding: '100px 32px 160px' }}>
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: 80, position: 'relative' }}>
            ...
            <p style={{ fontSize: 16, color: '#a1a1aa', fontWeight: 300 }}>Select your level of access.</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) minmax(340px, 1.2fr)', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{
              ...
              <h3 className={playfair.className} style={{ fontSize: 28, color: '#fff', marginBottom: 8, fontWeight: 500 }}>Initiate</h3>
              <p style={{ fontSize: 14, color: '#a1a1aa', marginBottom: 32 }}>For boutique agencies.</p>
              
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 40 }}>
                <span style={{ fontSize: 48, fontWeight: 300, color: '#fff' }}>$299</span>
                <span style={{ fontSize: 14, color: '#6b7280' }}>/ month</span>
              </div>

              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 48, flex: 1 }}>
                {['2,500 Emails / mo', 'Basic AI Personalization', 'Single User Seat'].map((f,i) => (
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                <h3 className={playfair.className} style={{ fontSize: 36, color: '#fff', fontWeight: 500 }}>Sovereign</h3>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#7c3aed"><path d="M12 2l3 6 6 1-4 4 1 6-6-3-6 3 1-6-4-4 6-1z"/></svg>
              </div>
              <p style={{ fontSize: 14, color: '#7c3aed', marginBottom: 32, fontWeight: 500 }}>Full Suite Access.</p>
              
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 40 }}>
                <span style={{ fontSize: 56, fontWeight: 300, color: '#fff', lineHeight: 1 }}>$899</span>
                <span style={{ fontSize: 14, color: '#6b7280' }}>/ month</span>
              </div>

              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 48, flex: 1 }}>
                {['Unlimited Emails', 'Advanced Generative AI', 'Priority Inbox Warm-up', 'Dedicated Account Manager'].map((f,i) => (
                   <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        ...
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
           ...
           <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span className={playfair.className} style={{ fontWeight: 700, fontSize: 18, color: '#fff' }}>Kylst</span>
          </div>
          ...
          <p style={{ fontSize: 13, color: '#6b7280' }}>
            © 2026 Kylst. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
